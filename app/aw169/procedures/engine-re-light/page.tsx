...
export default function EngineRelightProcedurePage() {
  return (
    ...
    return (
      <main className="mx-auto max-w-3xl p-6 space-y-6">
        <header className="rounded-xl border bg-white dark:bg-zinc-900 dark:border-zinc-700 p-4">
          <h1 className="text-xl font-semibold text-slate-900 dark:text-zinc-100">ENGINE RE-LIGHT (IN FLIGHT)</h1>
          <p className="mt-2 text-sm text-slate-700 dark:text-zinc-300">
            If an engine flames out and/or is shut down during flight and if there is no indication of a mechanical malfunction or engine fire, the engine may be restarted. In flight, only one restart attempt is available.
          </p>
        </header>
        ...
        <section className="space-y-3 rounded-xl border bg-white dark:bg-zinc-900 dark:border-zinc-700 p-4">
          <div className="text-sm text-slate-800 dark:text-zinc-100">
            Engine starting malfunctions are most likely to occur during the engine acceleration cycle to IDLE speed. Monitor engine start and if any of the following occurs:
          </div>
          <ul className="list-disc pl-6 text-sm text-slate-800 dark:text-zinc-100">
            ...
            <li>ITT invalid (shows X or blank)</li>
        ...
        <section className="space-y-3 rounded-xl border bg-white dark:bg-zinc-900 dark:border-zinc-700 p-4">
          <div className="text-sm text-slate-800 dark:text-zinc-100">Aborted engine restart — carry out:</div>
