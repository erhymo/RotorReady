...
export default function SingleEngineProcedurePage({ searchParams }: { searchParams?: { [key: string]: string | string[] | undefined } }) {
  ...
  if (compact) {
    return (
      <Link
        href={{
          pathname: "/training/lights",
          query: { resume: "1", v, light, mem, cwp: "1" },
        }}
