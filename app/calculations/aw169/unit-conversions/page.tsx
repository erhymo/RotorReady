...
export default function ConversionsPage() {
  ...
  const JET_A1_DENSITY = 0.8; // kg per litre (approx at 15C)
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 space-y-4">
      ...
      <section className="space-y-4">
        ...
        <div className="rounded-xl border bg-white p-4 shadow-sm dark:bg-zinc-900 dark:border-zinc-700">
          <h2 className="font-semibold text-slate-900 dark:text-zinc-100 mb-2">Fuel: Jet A-1 kg &lt;-&gt; litres</h2>
          <p className="text-xs text-slate-500 dark:text-zinc-400 mb-2">
            Uses approx density {JET_A1_DENSITY.toFixed(2)} kg/l at 15C.
          </p>
          <div className="grid gap-3 sm:grid-cols-2">
            <label className="text-sm space-y-1">
              <span className="block text-slate-700 dark:text-zinc-200">Kilograms</span>
              <input
                ...
                onChange={(e) => {
                  ...
                  setFuelKg(v);
                  const n = parseNum(v);
                  setFuelL(fmt(n != null ? n / JET_A1_DENSITY : null, 1));
                }}
              />
            </label>
            <label className="text-sm space-y-1">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setFuelL(v);
                  const n = parseNum(v);
                  setFuelKg(fmt(n != null ? n * JET_A1_DENSITY : null, 1));
                }}
              />
            </label>
          </div>
