  ...
  return (
    <div className="max-w-xl mx-auto p-6 rounded-2xl space-y-3 border-l-4 border-emerald-600 bg-emerald-50/40 dark:border-emerald-400 dark:bg-emerald-900/40">
      ...
      <p className="text-gray-600 dark:text-zinc-300">
        We have disabled subscriptions while RotorReady is in active development. You can use training, quizzes, and offline packages without payment.
      </p>
      <ul className="list-disc ml-5 text-sm text-gray-700 dark:text-zinc-300">
        <li>No Stripe checkout is shown.</li>
        <li>Login is optional for local training use.</li>
        <li>Account features like messages and sync still require sign-in.</li>
      </ul>
