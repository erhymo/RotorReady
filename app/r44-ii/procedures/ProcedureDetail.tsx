...
import type { ProcedureDefinition } from "@/lib/r44Procedures/data";

export default function ProcedureDetail({ procedure }: { procedure: ProcedureDefinition }) {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-zinc-900">
      <AppTopBar title="Procedure" backHref="/training/procedures/r44-ii" backLabel="Procedures" />
      <main className="mx-auto max-w-3xl p-6 space-y-6">
        ...
        <footer className="pt-2 text-center text-xs text-slate-500 dark:text-zinc-400">
          R44 II training reference. For training use only. Always cross-check with the latest approved POH.
        </footer>
      </main>
    </div>
  );
