...
const GRID: Slot[][] = [
  ...
  [
    ...
    { label: "MGB\nP", id: "mgb-oil-p", severity: "warning" },
    { label: "BATT\nTEMP", id: "bat-temp", severity: "warning" }
  ],
  // Row 3
  [
...
export default function Page() {
  ...
  // Ensure the active variant is B3e when landing directly on this page
  useEffect(() => {
