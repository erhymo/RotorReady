...
const VARIANT_ID = "H135_T3" as const;
...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-zinc-900">
      <AppTopBar title="CWP Trainer · H135 T3" backHref="/training/lights" backLabel="Lights" />
        ...
        <section className="rounded-xl border bg-white p-4 sm:p-6 shadow-sm dark:bg-zinc-900 dark:border-zinc-700">
          <div className="flex items-center justify-between flex-wrap gap-3 mb-4">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-semibold text-slate-900 dark:text-zinc-100">CWP-trainer · H135 T3</h1>
            </div>
