          ...
          <div className="space-y-6">
            ...
            {activeVariant.id === "AW169" && (
              <section className="space-y-4 rounded-xl border bg-white p-6 shadow-sm dark:bg-zinc-900 dark:border-zinc-700">
                <div className="flex items-center gap-2">
                  <span className="inline-block h-2.5 w-2.5 rounded-full bg-neutral-700" aria-hidden />
                  <h2 className="text-xl font-semibold text-slate-900 dark:text-zinc-100">Procedures</h2>
                </div>
                <p className="text-sm text-slate-600 dark:text-zinc-300">Browse AW169 procedures and open any procedure. Tap anywhere on the page to go back to the list.</p>
                <div>
                  <Link href="/training/procedures/aw169" className="inline-flex items-center rounded-md px-4 py-2 bg-black text-white font-medium hover:bg-black/90">
                    Open Procedures
                  </Link>
                </div>
              </section>
