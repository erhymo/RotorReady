...
export const H145D2_PROCEDURES: ProcedureDefinition[] = [
  {
    slug: "exterior-check",
    title: "EXTERIOR CHECK",
    subtitle: "Normal procedure",
    reference: "FLM BK117 D-2 Sect. 4.3.2 / 4.3.2.1",
    intro: (
      <>
    ...
    image: {
      src: "/training/procedures/pages/h145d2-exterior-check.png",
      alt: "H145 D2 exterior check walk-around sequence diagram",
      caption: "Fig. 4-1 Exterior check sequence — FLM BK117 D-2 Sect. 4.3.2.1",
    },
    groups: [
      {
  ...
  },
  {
    ...
    subtitle: "Normal procedure",
    reference: "FLM BK117 D-2 Sect. 4.4.1",
    notes: [
  ...
  },
  {
    ...
    subtitle: "Normal procedure",
    reference: "FLM BK117 D-2 Sect. 4.6 / 4.7 / 4.8",
    groups: [
      {
      ...
      },
      {
        ...
        steps: [
          { left: "1", right: <>Hover flight — Perform; N2/NR — Check ≥101%; FLI — Check AEO indication</> },
  ...
  },
  {
    ...
    subtitle: "Normal procedure",
    reference: "FLM BK117 D-2 Sect. 4.9 / 4.10",
    ...
    groups: [
      {
        ...
        steps: [
          ...
          { left: "2", right: <>N2/NR — Check increases to ≥101% below 50 KIAS</> },
      ...
      },
      {
        ...
        steps: [
          ...
          { left: "3", right: <>After landing: cyclic stick — Neutral position, press TRIM REL sw</> },
        ],
      },
      {
  ...
  },
  {
    ...
    subtitle: "Normal procedure",
    reference: "FLM BK117 D-2 Sect. 4.11",
    groups: [
      {
        heading: "Procedure",
        steps: [
  ...
  },
  {
    ...
    subtitle: "Normal procedure",
    reference: "FLM BK117 D-2 Sect. 4.13.4",
    cautions: [
  ...
  },
  {
    ...
    reference: "FLM BK117 D-2 Sect. 3.8.1 / 3.8.1.1-3.8.1.4",
    intro: (
      <>
    ...
    groups: [
      ...
      },
      {
        ...
        steps: [
          ...
          { left: "Transition to OEI", right: <>Collective lever — Adjust to OEI 30 sec limit or below; airspeed — gain Vy; reduce to OEI 2 min limit, then OEI MCP or below.</> },
          { left: "Then", right: <>Affected engine — Identify; Single engine emergency shutdown — Perform; if situation permits, perform in-flight restart; LAND AS SOON AS PRACTICABLE.</> },
        ],
      },
      {
  ...
  },
  {
    ...
    reference: "FLM BK117 D-2 Sect. 3.8.1 / 3.8.4.2",
    intro: (
      <>
  ...
  },
  {
    ...
    reference: "FLM BK117 D-2 Sect. 3.8.4.3",
    warnings: [
  ...
  },
  {
    ...
    reference: "FLM BK117 D-2 Sect. 3.8.4.4",
  ...
  },
  {
    slug: "engine-fire",
    title: "ENGINE FIRE",
    reference: "FLM BK117 D-2 Sect. 3.9.1",
    intro: (
      <>
  ...
  },
  {
    slug: "cabin-fire",
    title: "CABIN FIRE",
    reference: "FLM BK117 D-2 Sect. 3.9.3.1",
  ...
  },
  {
    ...
    reference: "FLM BK117 D-2 Sect. 3.9.3.2",
  ...
  },
  {
    ...
    reference: "FLM BK117 D-2 Sect. 3.11.1.1 / 3.11.1.2",
    groups: [
      {
  ...
  },
  {
    ...
    reference: "FLM BK117 D-2 Sect. 3.10.1",
    intro: (
      <>
  ...
  },
  {
    ...
    title: "SLOPE TAKEOFF",
    subtitle: "Normal procedure",
    reference: "FLM BK117 D-2 Sect. 4.8",
  ...
  },
  {
    ...
    title: "SLOPE LANDING",
    subtitle: "Normal procedure",
    reference: "FLM BK117 D-2 Sect. 4.10",
...
export function findH145D2Procedure(slug: string): ProcedureDefinition | undefined {
  return H145D2_PROCEDURES.find((p) => p.slug === slug);
}
