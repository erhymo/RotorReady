...
function inspect(file) {
  ...
  if (rects.length) {
    ...
    console.log('With verticals: none');
  }
...
if (!files.length) {
  console.log('Usage: node scripts/debug-aw169-candidates.mjs aw169-eng-fire-ground.svg [aw169-eng-fire-flight.svg]');
  process.exit(0);
}
