...
const PDF_PATH = path.resolve('_source/manuals/H145-D3(Fem blad)/PCL BK117D-3 SW V10 Rev. 5 .pdf');
const OUT_PATH = path.resolve('_source/qrh/h145d3-pcl-pages.txt');
